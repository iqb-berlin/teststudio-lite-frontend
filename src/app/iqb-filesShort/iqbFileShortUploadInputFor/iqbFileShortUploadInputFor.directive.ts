import { Component, Directive, ElementRef, EventEmitter, HostListener,
  ...
  @Directive({
    selector: 'input[iqbFileShortUploadInputFor], div[iqbFileShortUploadInputFor]',
  })
  export class IqbFileShortUploadInputForDirective  {
    ...
    @Input('iqbFileShortUploadInputFor')
    set fileShortUploadQueue(value: any) {
        if (value) {
            this._queue = value;
        }
    }
